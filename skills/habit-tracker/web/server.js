// web/server.js - Web API server for habit tracker (optimized)
...
// Import shared utilities from scripts/db.js
const { getLocalDate: getLocalDateShared } = require('../scripts/db');
...
/**
 * Get local date string - uses shared implementation from scripts/db.js
...
// API: Get today's timeline (checkins + logs merged)
...
// API: Get today's stream (same as timeline, alias for clarity)

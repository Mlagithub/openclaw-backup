# Warranty Void If Regenerated - 学习笔记

**来源**: https://nearzero.software/p/warranty-void-if-regenerated
**阅读日期**: 2026-03-18
**推荐人**: 止一
...
- 容器化类比：集装箱便宜，物流系统贵
- 与医疗行业对比：$50,000 手术不眨眼，$200 体检嫌贵
- 进化心理学：羚羊应对眼前的狮子，不担心下周的狮子
...
### 2026-03-18 16:27 - 部署 GSD 给 Claude

**任务**: 给 Claude 部署 Get Shit Done (GSD) 系统
**参考**: https://github.com/gsd-build/get-shit-done/blob/main/README.zh-CN.md
**状态**: 待处理
